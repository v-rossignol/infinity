...
> **État actuel** : `main.ts` n'applique pas encore ce préfixe. Les routes existantes répondent sur `/auth/*`, `/players/*`, etc. L'ajout de `app.setGlobalPrefix('infinity')` est requis pour aligner le serveur sur ce contrat.
...
- [ ] Ajouter `app.setGlobalPrefix('infinity')` dans `main.ts`
- [ ] Configurer le reverse proxy : `/infinity/*` → `http://localhost:4000/infinity/*`
